...
export interface Scene { id: string; number: string; sortOrder: number; name?: string | null; location?: string | null; intExt?: string | null; timeOfDay?: string | null; scriptDay?: string | null; synopsis?: string | null; pages?: string | null; shootDate?: string | null; status: string; characters: SceneCharacter[]; readiness?: string; continuity?: ContinuityRecord[]; cleaning?: CleaningRequest[] }
