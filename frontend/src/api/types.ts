...
export interface ProductionDocument { id: string; kind: "SCHEDULE" | "CALLSHEET"; fileName: string; url: string; date?: string | null; dayNumber?: number | null; scenes: number; appliedAt?: string | null; uploadedBy?: string | null; createdAt: string }
