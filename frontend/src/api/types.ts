...
export interface Character { id: string; name: string; type: string; age?: number | null; description?: string | null; notes?: string | null; actorId?: string | null; actor?: { id: string; name: string } | null; _count?: { scenes: number; changes: number; costumes: number } }
...
export interface Scene { id: string; number: string; sortOrder: number; hasScript?: boolean; aiEnabled?: boolean; cues?: ScriptCue[]; name?: string | null; location?: string | null; intExt?: string | null; timeOfDay?: string | null; scriptDay?: string | null; synopsis?: string | null; pages?: string | null; shootDate?: string | null; status: string; characters: SceneCharacter[]; readiness?: string; continuity?: ContinuityRecord[]; cleaning?: CleaningRequest[] }
