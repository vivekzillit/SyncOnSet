...
export interface Project extends ProjectSummary { prepStartDate?: string | null; prepEndDate?: string | null; prepWrapDate?: string | null; startDate?: string | null; endDate?: string | null; wrapDate?: string | null; notes?: string | null; currency: string; type?: string; studio?: string | null; budgetBand?: string | null; country?: string | null; city?: string | null }
...
export interface Scene { id: string; number: string; sortOrder: number; episode?: string | null; hasScript?: boolean; revision?: string | null; revisedAt?: string | null; aiEnabled?: boolean; cues?: ScriptCue[]; name?: string | null; location?: string | null; intExt?: string | null; timeOfDay?: string | null; scriptDay?: string | null; synopsis?: string | null; pages?: string | null; shootDate?: string | null; status: string; characters: SceneCharacter[]; readiness?: string; continuity?: ContinuityRecord[]; cleaning?: CleaningRequest[] }
