...
| **Production setup** | SyncOnSet-style wizard: feature / feature TV series, title, studio, pre-production and shoot dates, required script upload and Character Confirmation |
