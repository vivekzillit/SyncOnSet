...
| **Production setup** | SyncOnSet-style wizard: Feature / TV Series, title, studio, prep and shoot dates (start, end, optional wrap), optional script upload and Character Confirmation |
